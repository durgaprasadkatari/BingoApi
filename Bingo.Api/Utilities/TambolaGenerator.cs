...
namespace Bingo.Api.Utilities
{
    public class TicketGenerator
    {
        ...
        */
        ...
        private static int[,] RearrangeTicket(int[,] ticket, int[] rangeLengths)
        {
        ...
        */
        ...
        public static string PrintTicket(int[,] ticket)
        {
        ...
        */
        public static int[,] GenerateTicket(int[,] ticket)
        {
            ...
            for (int i = 1; i <= 9; i++)
            {
                ...
                if (num == 0)
                {
                    num = generator.Next(lowerBound, upperBound);
                }
            ...
            RearrangeTicket(ticket, rangeLengths);
